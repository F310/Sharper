...
namespace Sharper.Calculation
{
    public static class Memory
    {
        ...
        private static int numberOfBytesWritten;

        public static void Run(int processId)
        {
            processHandle = Import.OpenProcess(PROCESS_VM_OPERATION | PROCESS_VM_READ | PROCESS_VM_WRITE, false, processId);
        }
        ...
        public static T ReadMemory<T>(int address) where T : struct
        {
            ...
            Import.ReadProcessMemory((int)processHandle, address, buffer, buffer.Length, ref numberOfBytesRead);
        ...
        public static byte[] ReadMemory(int offset, int size)
        {
            ...
            Import.ReadProcessMemory((int)processHandle, offset, buffer, size, ref numberOfBytesRead);
        ...
        public static void WriteMemory<T>(int address, object Value) where T : struct
        {
            ...
            Import.WriteProcessMemory((int)processHandle, address, buffer, buffer.Length, out numberOfBytesWritten);
        }
